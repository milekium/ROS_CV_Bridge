...
(cl:defmethod linear_y-val ((m <DriveToTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ball_chaser-srv:linear_y-val is deprecated.  Use ball_chaser-srv:linear_y instead.")
  (linear_y m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DriveToTarget-request>)))
  ...
  "069780ac63038ccb6b52f7e9e7880ced")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DriveToTarget-request)))
  "Returns md5sum for a message object of type 'DriveToTarget-request"
  "069780ac63038ccb6b52f7e9e7880ced")

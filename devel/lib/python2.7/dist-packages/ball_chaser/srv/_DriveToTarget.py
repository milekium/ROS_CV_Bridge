...
class DriveToTargetRequest(genpy.Message):
  _md5sum = "17086575cf04ea52ca33141c3079cb71"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3d().pack(_x.linear_x, _x.linear_y, _x.angular_z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.linear_x, _x.linear_y, _x.angular_z,) = _get_struct_3d().unpack(str[start:end])
      return self
...
class DriveToTarget(object):
  ...
  _md5sum = '069780ac63038ccb6b52f7e9e7880ced'
